...
/* jshint -W069, esversion:6 */
  ...
  * is loaded
  */
 // The "console.log" gets run immediately when this is loaded and box02 exists
 if (document.getElementById("box02")) {
    console.log("Box 2 - a line in two.js");
 }
 ...
 window.onload = function() {
    ...
    /**
     * Only do this if the element box6par3 exists (when this file is loaded in box 6).
     */
    if (par) {
