...
window.onload = function() {
    ...
    if (span01) { // are we in box 1?
        span01.innerHTML = "write our text in the JavaScript Program";
    ...
    if (slider41 && slider42) { // are we in box 5?
    ...
    if (document.getElementById("box7-span1")) { // are we in box 7?
