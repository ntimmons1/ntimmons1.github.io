    ...
    */
    ...
    if (slider11 && slider12 && slider13){
        ...
        slider13.onchange = function() {
            var chg = Math.abs(Number(slider13.value)-slider13Old);
            var sliderDiff = Math.abs(Number(slider12.value)-Number(slider11.value));
            if(Number(slider13.value)>chg){
                slider11.value = (Number(slider11.value)-(Math.round(chg/2))).toString();
                slider12.value = (Number(slider12.value)+(Math.round(chg/2))).toString();
            }
            else{
                slider11.value = (Number(slider11.value)+(Math.round(chg/2))).toString();
                slider12.value = (Number(slider12.value)-(Math.round(chg/2))).toString();
            }
            slider13Old = Number(slider13.value);
        };
        function getDiff(){
